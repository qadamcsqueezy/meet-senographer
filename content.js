...
const extensionStatusJSON_bug = {
  "status": 400,
  "message": "<strong>Meet Stenographer encountered a new error</strong> <br /> Please report it <a href='https://github.com/qadamcsqueezy/meet-senographer/issues' target='_blank'>here</a>."
}
const reportErrorMessage = "There is a bug in Meet Stenographer. Please report it at https://github.com/qadamcsqueezy/meet-senographer/issues"
...
async function checkExtensionStatus() {
  ...
  chrome.storage.local.set({
    extensionStatusJSON: { status: 200, message: "<strong>Meet Senographer is running</strong> <br /> Do not turn off captions" },
  });
